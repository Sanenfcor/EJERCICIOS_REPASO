...
<body>
    ...
    $apiUrl = "https://api.nasa.gov/mars-photos/api/v1/rovers/$rover/photos?sol=$sol&page=$pag";
    ...
    curl_setopt($curl_v2, CURLOPT_HTTPAUTH, CURLAUTH_BASIC); // Para habilitar la transferencia de datos
    curl_setopt($curl_v2, CURLOPT_USERPWD, $api_key . ":"); // Para habilitar la transferencia de datos
    ...
    <h3>ROVER: <?= strtoupper($rover) ?></h3> <!-- Indicamos el "sol" en el que nos encontramos -->
            ...
            <table border="5px solid black" style="margin:auto; margin-top:2rem; margin-bottom:2rem; text-align:center; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    foreach($fotos as $foto){ ?>
                        <tr>
                            <td><h3><?= $foto["id"] ?></h3></td>
                            <td><a href="<?= $foto["img_src"] ?>"><img src="<?= $foto["img_src"] ?>" alt="fotito" height="300px" width="300px"></a></td>
